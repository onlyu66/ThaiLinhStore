...
function Article() {
  ...
  products.map((element) => {
    if (element.saling) {
      prominentProducts.push(element);
    }
  });
        ...
        <Carousel data-bs-theme="dark" className="carousel">
          <Carousel.Item>
            <ul className="p-0 pt-2 m-0 flex flex-wrap justify-center ">
              {prominentProducts.map((element, index) => {
                if (index <= 4 && element.type === "phone") {
                  return (
                    <li
                      className={clsx(
                        styles.item,
          ...
          <Carousel.Item>
            <ul className="p-0 pt-2 m-0 flex flex-wrap justify-center ">
              {products.map((element, index) => {
                if (index >= 1 && index <= 5 && element.type === "phone") {
                  return (
                    <li
                      className={clsx(
                        styles.item,
          ...
          <Carousel.Item>
            <ul className="p-0 pt-2 m-0 flex flex-wrap justify-center ">
              {products.map((element, index) => {
                if (index >= 2 && index <= 6 && element.type === "phone") {
                  return (
                    <li
                      className={clsx(
                        styles.item,
          ...
          <Carousel.Item>
            <ul className="p-0 pt-2 m-0 flex flex-wrap justify-center ">
              {products.map((element, index) => {
                if (index >= 3 && index <= 7 && element.type === "phone") {
                  return (
                    <li
                      className={clsx(
                        styles.item,
      ...
      >
        ...
        <Carousel data-bs-theme="dark" className="carousel">
          ...
          <Carousel.Item>
            <ul className="p-0 pt-2 m-0 flex flex-wrap justify-center ">
              {products.map((element, index) => {
                if (index >= 1 && index <= 4 && element.type === "phone") {
                  return (
                    <li
                      className={clsx(
                        styles.item,
          ...
          <Carousel.Item>
            <ul className="p-0 pt-2 m-0 flex flex-wrap justify-center ">
              {products.map((element, index) => {
                if (index >= 2 && index <= 5 && element.type === "phone") {
                  return (
                    <li
                      className={clsx(
                        styles.item,
          ...
          <Carousel.Item>
            <ul className="p-0 pt-2 m-0 flex flex-wrap justify-center ">
              {products.map((element, index) => {
                if (index >= 3 && index <= 6 && element.type === "phone") {
                  return (
                    <li
                      className={clsx(
                        styles.item,
